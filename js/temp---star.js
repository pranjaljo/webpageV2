// giveMeStars = function (n) {
//     let backShadow = ``;
//     for (let i = 1; i < n; i++) {
//       const random1 = Math.floor(Math.random() * 2000);
//       const random2 = Math.floor(Math.random() * 2000);
//       backShadow += `${random1}px ${random2}px #FFF,`;
//     }
//     return backShadow.slice(0, -1);
//   };
  
//   const starSlow = giveMeStars(250);
//   const starAvg = giveMeStars(120);
//   const starFast = giveMeStars(50);
  
//   const root = document.querySelector(":root");
//   root.style.setProperty("--star1", starSlow);
//   root.style.setProperty("--star2", starAvg);
//   root.style.setProperty("--star3", starFast);
